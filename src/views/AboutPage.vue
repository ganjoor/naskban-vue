...
onMounted(() => {
  document.title = 'نسکبان - معرفی'
})
</script>
<template>
  <div class="flex flex-center">
    <q-card class="q-pa-md shadow-2 login-card" bordered>
      <div class="text-grey-9 text-h5 text-weight-bold text-center">معرفی نسکبان</div>
      <q-card-section>
        <p>
          نسکبان یک کتابخانه از فایل‌های PDF کتاب‌های فارسی است که امکان جستجو در متن آنها وجود
          دارد.
        </p>
        <p>
          در حال حاضر همهٔ کتاب‌های آن از
          <a href="https://sohalibrary.com" target="_blank">سها</a> دریافت شده‌اند.
        </p>
        <p>
        ...
        <p>
          برای آشنایی با امکانات نسکبان
          <a href="https://blog.ganjoor.net/?p=2840" target="_blank">اینجا</a> را ببینید.
        </p>
        <p>
